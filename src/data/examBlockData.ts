...
export const examBlocks: ExamBlock[] = [
  // 1. Institution-wide Term Exam (3 days, full day, hard block)
  {
    id: 'block-1',
  ...
  // 2. JEE Course Morning Exam (single day, 9:00-12:00, hard block)
  {
    id: 'block-2',
