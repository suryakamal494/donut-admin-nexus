...
import { Upload, FileText, CheckCircle, ArrowLeft, Loader2, ChevronRight, ChevronLeft } from "lucide-react";
...
import { getPublishedCourses, getSubjectsForCourse, getChaptersForCourseBySubject } from "@/data/masterData";
...
const UploadCoursePDF = () => {
  ...
  const canProceed = selectedCourse && selectedSubject;
      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="bg-card rounded-2xl p-12 shadow-soft border text-center max-w-2xl mx-auto">
          ...
          <div className="flex justify-center gap-4">
            <Link to="/superadmin/questions/course">
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader
        ...
        description="Upload exam papers to extract questions for the course"
        breadcrumbs={[
          { label: "Course Questions", href: "/superadmin/questions/course" },
          { label: "Upload PDF" },
        ]}
